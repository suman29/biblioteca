...
public class BibliotecaApp {
    ...
    private static ArrayList<Book> availableListOfBooks() {
        ...
        availableBookList.add(new Book("Lets C", "Yashwant", 1990, 1));
        availableBookList.add(new Book("Head First Java", "Kathy", 1993,2));
        availableBookList.add(new Book("Learn Java", "John", 2000,3));
    ...
    private static ArrayList<Book> checkedOutListOfBooks() {
        ...
        checkedOutBookList.add(new Book("Book1", "suman", 1990, 3));
        checkedOutBookList.add(new Book("Book2", "Ashray", 1993, 4));
        checkedOutBookList.add(new Book("Book3", "Sourav", 2000, 5));
